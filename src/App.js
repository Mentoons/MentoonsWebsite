...
function App() {
  ...
  return (
    <div>
      {loading ? (
        <Lottie animationData={loding} className="loding" />
      ) : (
        <BrowserRouter>
          <Routes>
            ...
            <Route
              path="/Mentoonstore"
              element={<Mentoonstore cartitems={cartitems} />}
            />
            ...
            <Route
              path="/Checkout"
              element={<Checkout product={cartitems} deleteItem={deleteItem} />}
            />
            ...
            <Route
              path="/Cart"
              element={<Cart product={cartitems} deleteItem={deleteItem} />}
            />
